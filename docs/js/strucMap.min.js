function loadMap(options, nodesJson, linkJson) {
	var t = options,
		a = nodesJson,
		n = linkJson,
		color = { notStarted: { fill: "#ddd", outline: "#bbb" }, researched: { fill: "#69b969", outline: "#2ca02c" }, focusedOn: { fill: "#fe8d69", outline: "#e94e29" } },
		l = t.width,
		i = t.height,
	...
	p.append("circle").attr({
		...
		fill: function (t) {
			switch (t.prop.status) {
				case "researched":
					return color.researched.fill;
				case "currently focused on":
					return color.focusedOn.fill;
				default:
					return color.notStarted.fill;
			}
		...
		stroke: function (t) {
			switch (t.prop.status) {
				case "researched":
					return color.researched.outline;
				case "currently focused on":
					return color.focusedOn.outline;
				default:
					return color.notStarted.outline;
			}
		},
		"stroke-width": "2px"
